...
//My-Works
export const MY_WORKS_TITLE= "Here you can check some of my works!";
export const MY_WORKS_REIKI_DESCRIPTION= "Reiki Usui Terapia Its a web page with a beautiful Front end in React";
export const MY_WORKS_OMNIFOOD_DESCRIPTION = "Omnifood its a good example of a landing page with a cool front end with a pure HTML5 , css3 and Javascript";
export const MY_WORKS_SMARTBRAIN_DESCRIPTION = "Smart Brain Its a React app that runs in Heroku with an Express js server and a Postgres Data base";